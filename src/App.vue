                      ...
                      >
                        ...
                        >
                          <input
                            ...
                            id="objectswitcher-combobox-id-2"
                            aria-controls="objectswitcher-listbox-id-2"
                            autocomplete="off"
                            role="textbox"
                            placeholder=" "
                            value="Accounts"
                          ...
                          >
                            <svg
                              ...
                              aria-hidden="true"
                            >
                              <use xlink:href="~slds/assets/icons/utility-sprite/svg/symbols.svg#down" />
                            </svg>
                          </span>
                        </div>
                        <div
                                ...
                                <span class="slds-media__figure slds-listbox__option-icon">
                                  ...
                                  >
                                    <svg class="slds-icon slds-icon_x-small" aria-hidden="true">
                                      <use
                                        xlink:href="~slds/assets/icons/utility-sprite/svg/symbols.svg#check"
                                      />
                                    </svg>
                                  </span>
                                </span>
                  ...
                  >
                    ...
                    >
                      <svg
                        ...
                        aria-hidden="true"
                      >
                        <use xlink:href="~slds/assets/icons/utility-sprite/svg/symbols.svg#search" />
                      </svg>
                    </span>
                    <input
                      type="text"
                      ...
                      <li role="presentation" class="slds-listbox__item">
                        ...
                        >
                          <span class="slds-media__figure slds-listbox__option-icon">
                            <span class="slds-icon_container slds-icon-standard-opportunity">
                              <svg class="slds-icon slds-icon_small" aria-hidden="true">
                                <use
                                  xlink:href="~slds/assets/icons/standard-sprite/svg/symbols.svg#opportunity"
                                />
                              </svg>
                            </span>
                          </span>
                          <span class="slds-media__body">
                            ...
                            >Salesforce - 1,000 Licenses</span>
                            <span
                              class="slds-listbox__option-meta slds-listbox__option-meta_entity"
                            >Opportunity • Propecting</span>
                          </span>
                        </div>
                      </li>
                      <li role="presentation" class="slds-listbox__item">
                        ...
                        >
                          <span class="slds-media__figure slds-listbox__option-icon">
                            <span class="slds-icon_container slds-icon-standard-contact">
                              <svg class="slds-icon slds-icon_small" aria-hidden="true">
                                <use
                                  xlink:href="~slds/assets/icons/standard-sprite/svg/symbols.svg#contact"
                                />
                              </svg>
                            </span>
                          </span>
                          <span class="slds-media__body">
                            ...
                            <span
                              class="slds-listbox__option-meta slds-listbox__option-meta_entity"
                            >Contact • avandelay@vandelay.com</span>
                          </span>
                        </div>
                      </li>
                      <li role="presentation" class="slds-listbox__item">
                        ...
                        >
                          <span class="slds-media__figure slds-listbox__option-icon">
                            <span class="slds-icon_container slds-icon-standard-account">
                              <svg class="slds-icon slds-icon_small" aria-hidden="true">
                                <use
                                  xlink:href="~slds/assets/icons/standard-sprite/svg/symbols.svg#account"
                                />
                              </svg>
                            </span>
                          </span>
                          <span class="slds-media__body">
                            <span
                              class="slds-listbox__option-text slds-listbox__option-text_entity"
                            >Vandelay Industries</span>
                            <span
                              class="slds-listbox__option-meta slds-listbox__option-meta_entity"
                            >Account • San Francisco</span>
                          </span>
                        </div>
                      </li>
                      <li role="presentation" class="slds-listbox__item">
                        ...
                        >
                          <span class="slds-media__figure slds-listbox__option-icon">
                            <span class="slds-icon_container slds-icon-standard-event">
                              <svg class="slds-icon slds-icon_small" aria-hidden="true">
                                <use
                                  xlink:href="~slds/assets/icons/standard-sprite/svg/symbols.svg#event"
                                />
                              </svg>
                            </span>
                          </span>
                          <span class="slds-media__body">
                            <span
                              class="slds-listbox__option-text slds-listbox__option-text_entity"
                            >Salesforce UK 2016 Events</span>
                            <span
                              class="slds-listbox__option-meta slds-listbox__option-meta_entity"
                            >Event • $20,000</span>
                          </span>
                        ...
                        >
                          <span class="slds-media__figure slds-listbox__option-icon">
                            <span class="slds-icon_container slds-icon-standard-lead">
                              <svg class="slds-icon slds-icon_small" aria-hidden="true">
                                <use
                                  xlink:href="~slds/assets/icons/standard-sprite/svg/symbols.svg#lead"
                                />
                              </svg>
                            </span>
                          </span>
        ...
        <ul class="slds-global-actions">
              ...
              <div class="slds-button-group">
                ...
                >
                  <svg class="slds-button__icon" aria-hidden="true">
                    <use xlink:href="~slds/assets/icons/utility-sprite/svg/symbols.svg#favorite" />
                  </svg>
          ...
          <li class="slds-global-actions__item">
            <div class="slds-dropdown-trigger slds-dropdown-trigger_click">
              ...
              >
                <svg class="slds-button__icon" aria-hidden="true">
                  <use xlink:href="~slds/assets/icons/utility-sprite/svg/symbols.svg#add" />
                </svg>
            ...
            <div class="slds-dropdown-trigger slds-dropdown-trigger_click">
              ...
              >
                <svg class="slds-button__icon slds-global-header__icon" aria-hidden="true">
                  <use xlink:href="~slds/assets/icons/utility-sprite/svg/symbols.svg#question" />
                </svg>
          ...
          <li class="slds-global-actions__item">
            <div class="slds-dropdown-trigger slds-dropdown-trigger_click">
              ...
              >
                <svg class="slds-button__icon slds-global-header__icon" aria-hidden="true">
                  <use xlink:href="~slds/assets/icons/utility-sprite/svg/symbols.svg#setup" />
                </svg>
          ...
          <li class="slds-global-actions__item">
            <div class="slds-dropdown-trigger slds-dropdown-trigger_click">
              ...
              >
                <svg class="slds-button__icon slds-global-header__icon" aria-hidden="true">
                  <use xlink:href="~slds/assets/icons/utility-sprite/svg/symbols.svg#notification" />
                </svg>
            ...
            <div class="slds-dropdown-trigger slds-dropdown-trigger_click">
              ...
              >
                <span class="slds-avatar slds-avatar_circle slds-avatar_medium">
                  <img alt="Person name" src="~slds/assets/images/avatar2.jpg" title="User avatar" />
                </span>
              </button>
            </div>
          </li>
...
<style lang="scss">
  ...
  $brand-logo-image: 'assets/logo.png';
